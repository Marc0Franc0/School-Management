...
public class SubjectController {
   ...
   @PostMapping("/")
   public ResponseEntity<String> createSubject(@Valid @RequestBody SubjectRequest subject, BindingResult bindingResult ){
   ...
   @PutMapping("/{id}")
   public ResponseEntity<String> updateSubject(@PathVariable Long id,@RequestBody SubjectRequest subject) {
